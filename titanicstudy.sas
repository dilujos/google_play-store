...
proc import datafile ='/home/u59065022/dataset/Titanic.csv'
out=titanic dbms=csv replace;
...
/*4.count survived and show on pie chart*/
...
/*5.Find out how many female passengers had travelled in first class and show on pie chart*/
...
/*6. Find out how many female passengers had Survived and her age <30, show on pie chart and bar graph */
...
/*7. Find out how many male passengers had Survived and his age >40, show on pie chart */
...
/*9.Show age frequency with survived and not survived (Histogram)*/
...
/*10.Show Bar graph for Survived with male, female, class*/
	PROC FREQ DATA = titanic;
	  TABLES sex*survived*pclass /NOCOL nocum NOPERCENT plots=freqplot(twoway=stacked type=barplot);
	  
	RUN;

/*11.How many passengers are travelled in different classes show in Bar graph*/
...
/*12.How many passengers are survived with class wise and show in Bar graph*/
